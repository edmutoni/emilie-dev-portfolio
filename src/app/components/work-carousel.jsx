...
const work = [
  {
    ...
    image: <img src="textured-turtle.png" className="image-frame" alt="3D textured turtle"/>,
  ...
  },
  {
    ...
    image: <img src="drum_screenshot.png" className="image-frame" alt="VR drum game screenshot"/>,
    ...
    button: <Button className = "align-self-center"style={{fontStyle :"italic"}} variant="secondary" href="https://github.com/carolina-ar-vr/drum-rhythm-game" target="_blank">git repo</Button>,
    tags: "#Unity #CSharp",
  },

  {
    title: "Vanilla HTML, CSS, and JavaScript Portfolio Website",
    image: <img src="simple_site.png" className="image-frame" alt="Simple website screenshot"/>,
  ...
  },
  {
    ...
    image: <div className="image-frame bg-gray-200 flex items-center justify-center text-gray-500">Image placeholder</div>, 
...
function CustomSlide(props){
  ...
  return (
    <div className="carousel-container border border-black w-3/4 m-auto py-15" style={{maxWidth: 800}}>
      ...
      <div className="carousel-right-column">
        <h3 className="slide-title" style={{fontSize: 20, fontStyle: "italic"}}>{title}</h3>
...
export default function WorkCarousel() {
  var settings = {
   ...
   return (
    <div className="w-3/4 m-auto" style={{maxWidth: 800}}>
      <Slider {...settings}>
      {work.map((w, index) => (
        <CustomSlide 
          key={index}
